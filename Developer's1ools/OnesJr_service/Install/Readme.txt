Сервис читает журнал регистрации с клиент сервиной версии 1С.
...
"ElasticUserPassword":null - пароль пользователя для идентификации в эластике

Логи содаются в папке сервиса - OnecLogElastic.log.
